  ...
  fields: [
    {
      ...
      title: "Title",
      type: "string",
      description: "The name of the unstitched dress (e.g., 'Lawn Unstitched 3 Piece')",
    ...
    },
    {
      ...
      title: "Fabric Type",
      type: "string",
      description: "E.g., Lawn, Linen, Chiffon",
    },
    {
      name: "description",
      title: "Description",
    ...
    },
    {
      ...
      type: "array",
      of: [{ type: "string" }],
      description: "Example: Shirt, Dupatta, Trouser",
    },
    {
      name: "image",
      title: "Main Image",
    ...
    },
    {
      ...
      description: "Upload a size chart image if available",
    },
    {
      name: "color",
      title: "Color",
    ...
    },
    {
      ...
      type: "boolean",
      description: "Mark if you want to show this product on the homepage",
    },
    {
      name: "createdAt",
      title: "Created At",
